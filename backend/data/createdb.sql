...
ALTER TABLE public.crashes RENAME TO temp_crashes;

create table temp_crashes
(
    crash_ref_number integer PRIMARY KEY,
    crash_severity text,
    crash_year integer,
    crash_month text,
...
CREATE INDEX location_idx ON crashes USING GIST(location_geometry_wgs84);
